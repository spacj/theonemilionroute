  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex items-center justify-center w-full">
        <div className="w-full sm:w-[90vw] sm:h-[10vh] md:w-[80vw] md:h-[20vh] xl:w-[70vw] flex items-center justify-center overflow-hidden">
      ...
      <div className="flex items-center justify-center w-full">
        <div className="w-full sm:w-[90vw] sm:h-[10vh] md:w-[80vw] xl:w-[70vw] md:h-[20vh] flex items-center justify-center overflow-hidden">
